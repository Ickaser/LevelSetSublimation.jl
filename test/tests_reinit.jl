...
@testset "WENO derivative tests: tested on ellipse front" begin
    @test sum(approxzero.(dϕdx_all_4[1] .- dϕdx_all_4_alt[1])) == dom.ntot  # New and old implementations match
    @test sum(approxzero.(dϕdx_all_4[2] .- dϕdx_all_4_alt[2])) == dom.ntot  # New and old implementations match
    @test sum(approxzero.(dϕdx_all_4[3] .- dϕdx_all_4_alt[3])) == dom.ntot  # New and old implementations match
    @test sum(approxzero.(dϕdx_all_4[4] .- dϕdx_all_4_alt[4])) == dom.ntot  # New and old implementations match
